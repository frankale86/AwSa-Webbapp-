 ...
 <!-- Por ahora estoy haciendo Pruebas de la Informacion de la Tabla para que se pueda Ver., -->
	...
	<div class="container">
		<div class="actions text-left">	
		    <h1>Adición Registro de Perfiles de Usuario</h1>
	    	<p>Link: menú general / Datos Maestros / perfiles / Adicionar Perfil</a></p>
	         ...
	         <div class="card-body">
				...
				int idperfil = 1;
						try {
							...
							String sql = "SELECT max(idperfil) FROM perfiles";
							ResultSet rst = stmt.executeQuery(sql);
							while (rst.next()) {
								idperfil = rst.getInt(1);
								idperfil = idperfil + 1;
				...
				<form class="form-sign" action="AdperfilesAction.jsp" method="POST">
					...
					<div class="row">
						<div class="col-md-2 mb-3">
							<label for="codigoidperfil" class="form-label" ># Reg.</label>
							<input type="text" name="idperfil" class="form-control" value="<%out.println(idperfil);%>" readonly="readonly" required>
						</div>
						<div class="col-md-6 mb-3">
							<label for="descripcion_perfil" class="form-label">Descripción Perfil</label> 
							<input type="text" name="descripcion_perfil"class="form-control" id="formGroupExampleInput" placeholder="Descripción Perfil" required>
						</div>						
