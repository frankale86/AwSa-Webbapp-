...
<!--6 -->                                <input type="text" id=campoAmplio name="campoAmplio" class="form-control" placeholder="Campo Amplio" >                            
		                        ...
		                        <div class="control-group">
		                            ...
		                            <div class="controls">
<!--7 -->                                <input type="text" id=campoEspecifico name="campoEspecifico" class="form-control" placeholder="Campo específico" >
		                            </div>
		                        </div>		                        
		                        ...
		                        <div class="control-group">
		                            ...
		                            <div class="controls">
<!--8 -->                                <input type="text" id=campoDetallado name="campoDetallado" class="form-control" placeholder="Campo específico" >
		                            </div>
		                        </div>		                        

		                        <div class="control-group">
				                     <label class="control-label" for=
		                            "formacion">Nivel de formación</label>		
		                            <div class="controls">
			                            <%
			                            try {
			                            	Connection con=ConnectionSac.getCon();
...
<!--10 -->  	   						        <select id="idmodalidad" name="idmodalidad" class="form-select" required>
		                        ...
		                        <div class="control-group">
		                            ...
		                            <div class="controls">
<!--11 -->                                <input type="text" id=nroCreditos name="nroCreditos" class="form-control" placeholder="Número de créditos" >
		                            </div>
		                        </div>			                        
		                        ...
		                        <div class="control-group">
		                            ...
		                            <div class="controls">
<!--12 -->                                <input type="text" id=notaInterna name="notaInterna" class="form-control" placeholder="Nota Interna de creación" >
		                            </div>
		                        </div>			                        
...
<!--13 -->                                <input type="text" id=instancia name="instancia" class="form-control" placeholder="Instancia que cumple la norma" type="text" >
		                        ...
		                        <div class="control-group">
		                            ...
		                            <div class="controls">
<!--14 -->                                <input type="text" id=snies name="snies" class="form-control" placeholder="Código SNIES" type="text" >
		                            </div>
		                        </div>
		                </div>
...
<!--15 -->							 <input type="date" id="inicioActividades" name="inicioActividades" class="form-control">
							...
							<div class="control-group">
	                            ...
	                            <div class="controls">
<!--16 -->                          <input type="text" id="resolucionVigencia" name="resolucionVigencia" class="form-control" placeholder="Resolución de Registro Calificado Vigente" type="text" >	                                
	                            </div>
	                        </div>
	                        ...
	                        <div class="control-group">
	                            ...
	                            <div class="controls">
<!--17 -->                          <input type="text" id="resolucionAcreditacion" name="resolucionAcreditacion" class="form-control" placeholder="Resolución de Acreditación" type="text" >	                                
	                            </div>
	                        </div>
		                    ...
		                    <div class="control-group">
	                            ...
	                            <div class="controls">
<!--18 -->                           <input type="text" id="duracion" name="duracion" class="form-control" placeholder="Duración del programa (en semestres)" type="text" >
	                            </div>
	                        </div>
	                        ...
	                        <div class="control-group">
	                            ...
	                            <div class="controls">
<!--19 -->                           <input id="porcentajeT" name="porcentajeT" class="form-control" placeholder="Porcentaje de inclusión de tecnología (indique %)" type="text" >	                                
	                            </div>
	                        </div>
...
<!--21 -->                           <input id="jornada" name="jornada" class="form-control" placeholder="Jornada de ofrecimiento del programa" type="text" >                            
	                        ...
	                        <div class="control-group">
	                            ...
	                            <div class="controls">
<!--22 -->                           <input id="nroEstudiantes" name="nroEstudiantes" class="form-control" placeholder="Número de estudiantes aprobados primer curso" type="text" >
	                            </div>
	                        </div>
	                        ...
	                        <div class="control-group">
	                            ...
	                            <div class="controls">
<!--23 -->                           <input id="valorMatricula" name="valorMatricula" class="form-control" placeholder="Valor de la Matrícula" type=text >
	                            </div>
	                        </div>
