...
<!-- fin Parte superior Verde -->	
	...
	<div class="container">
		<div class="actions text-left">	
		    <h2>Listado General de Factor o Condición de Calidad Programas</h2>
	    	<p>Link: menú general / Datos Maestros / factor</a></p>
	    </div>
		      		...
		      		<table id="ejemplo" class="table table-striped table-bordered" style="width:100%">
							...
							<tbody>
									...
									try{
										...
										String query="SELECT * FROM factorProgramas";
										...
										while (rs.next()){
											...
											<td>
												<div class="progress">
												  <div class="progress-bar" role="progressbar" style="width: <%=rs.getString(3)%>%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"><%=rs.getString(3)%></div>
												</div>
											</td>
											<td>     
										      <div class="btn-group">
										        ...
										        <ul class="dropdown-menu">
										          <li><a href="EditarFactorPrograma.jsp?idarea=<%=rs.getString(1)%> type="button">Actualizar</a></li>
