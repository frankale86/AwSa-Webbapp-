											...
											<td>     
										      <div class="btn-group">
										        ...
										        <ul class="dropdown-menu">
										          <li><a href="EditarProgramas.jsp?idprograma=<%=rs.getString(1)%> type="button">Actualizar</a></li>
										          <!-- <li><a href="EditarProgramaPrueba.jsp?idprograma=<%=rs.getString(1)%> type="button">Actualizar</a></li> -->
