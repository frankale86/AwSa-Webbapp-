 ...
 <!-- Por ahora estoy haciendo Pruebas de la Informacion de la Tabla para que se pueda Ver., -->
	...
	<div class="container">
		<div class="actions text-left">	
		    <h1>Adición Registro de Formación</h1>
	    	<p>Link: menú general / Datos Maestros / formación / Adicionar Formación</a></p>
	         ...
	         <div class="card-body">
				...
				int idformacion = 1;
						try {					
							...
							String sql = "SELECT max(idformacion) FROM formacion";
							ResultSet rst = stmt.executeQuery(sql);
							while (rst.next()) {
								idformacion = rst.getInt(1);
								idformacion = idformacion + 1;
				...
				<form class="form-sign" action="AdformacionAction.jsp" method="POST">
					<div class="form-group text-center">
						<figure class="text-center">
							<h2></h2>
						<figure class="text-center">
							<!-- <h5 style="color: #198754">Bienvenido al Módulo de Adición</h5> 
							<h5 style="color: #198754">Por favor digite la información requerida y presione presione "Agregar" al finalizar</h5> -->

					<div class="row">
						<div class="col-md-2 mb-3">
							<label for="codigoidformacion" class="form-label" ># Reg.</label>
							<input type="text" name="idformacion" class="form-control" value="<%out.println(idformacion);%>" readonly="readonly" required>
						</div>
						<div class="col-md-6 mb-3">
							<label for="nombreformacion" class="form-label">Descripción Formación</label> 
							<input type="text" name="nombreformacion"class="form-control" id="formGroupExampleInput" placeholder="Descripción de la Formación" required>
						</div>						
						     ...
						     <div class="col-md-6">
						     	 <div class="actions text-left">					
 									  <button style="background-color: #198754; color: #FFFFFF; border: #198754 1px solid" type="submit" name="accion" value="Agregar" class="btn btn-success">Agregar</button>
										    <a href="Lformacion.jsp">
								       <button type="button" name="regresar" class="btn btn-warning" data-toggle="modal" data-target="#squarespaceModal">Regresar / Cancel</button></a>
								 </div>
							 </div> 							    
						</div>
					</div>
