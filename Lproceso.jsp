...
<!-- fin Parte superior Verde -->	
	...
	<div class="container">
		<div class="actions text-left">	
		    <h1>Listado General de Procesos de Aseguramiento</h1>
	    	<p>Link: menú general / Datos Maestros / procesos de aseguramiento</a></p>
	    </div>
		  
		  <form class="form-sign" action="Adproceso.jsp" method="POST">
		  
		  <div class="row">
		       <div class="col-12" >
					<div class="actions text-left">		
				             <a href="Adproceso.jsp"><button type="submit" name="adicionar" class="btn btn-success">Adicionar Registro</button></a>
