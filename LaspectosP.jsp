...
<!-- fin Parte superior Verde -->	
	...
	<div class="container"> 
	      <div class="actions text-left">	
			    <h1>Listado General de Aspectos -Institucionales</h1>
			   	<p>Link: menú general / Datos Maestros / Aspectos -Institucionales</a></p>         		    	
		  </div>
		      		...
		      		<table id="ejemplo" class="table table-striped table-bordered" style="width:100%">
							...
							<tbody>
									...
									try{
										...
										String query="SELECT *, if(estado = 1, 'Activo','Inactivo') as estado FROM caracteristica_aspevaluarp";
