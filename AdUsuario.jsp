...
<!-- *****************************************************   *Manejo de Tabs -->
			<div class="container">
				 <ul class="nav nav-tabs">
				     <li class="nav-item">
				         <a class="nav-link active" data-toggle="tab" href="#home">1. Información Básica Usuario.</a>
				     </li>
				     <li class="nav-item">
				         <a class="nav-link" data-toggle="tab" href="#menu1">2. Permisos y Restricciones.</a>
				     </li>
				     <li class="nav-item">
				         <a class="nav-link" data-toggle="tab" href="#menu2">3. Otra Información de Usuario.</a>
				     </li>
				 </ul>
				 ...
				 <div class="tab-content">
					  ...
					  <div id="home" class="container tab-pane active"><br>
					       <h3><img src="img/png/direccion.png" width="50" height="50">1. Información Básica Usuario.</h3>
					  <!-- Contenido Tab 1 -->					       					       
						   	<div class="row-fluid">
						       	<div class="span12">	       	
															...
															<form>
																...
																<label class="form-check">
																	  ...
																	  <span class="form-check-label">
																	        0. Condición. Inicio del Proceso.
																	  </span>
																</label>  <!-- form-check.// -->
																...
																<label class="form-check">
																	  <input class="form-check-input" type="checkbox" value="">
																	  <span class="form-check-label">
																	        3. Condición. Aspectos curriculares.
																	  </span>
																</label>  <!-- form-check.// -->
																...
																<label class="form-check">
																	  <input class="form-check-input" type="checkbox" value="">
																	  <span class="form-check-label">
																	        4. Condición. Organización actividades académicas.
																	  </span>
																</label>  <!-- form-check.// -->
																...
																<label class="form-check">
																	  <input class="form-check-input" type="checkbox" value="">
																	  <span class="form-check-label">
																	        6. Condición. Relación con el sector externo.
																	  </span>
																</label>  <!-- form-check.// -->
																...
																<label class="form-check">
																	  <input class="form-check-input" type="checkbox" value="">
																	  <span class="form-check-label">
																	    	9. Condición. Infraestructura física y tecnológica.
																	  </span>
																</label>  <!-- form-check.// -->
...
<!-- ================================================================================================= -->					       
					  ...
					  <div id="menu2" class="container tab-pane fade"><br>
						   <h3><img src="img/png/direccion.png" width="50" height="50">3. Otra Información de Usuario.</h3>
		                   <div class="control-group">
	                            <label class="control-label">Registro Usuario Nro.</label>	
	                            <div class="controls">
						   ...
						   <p>Espacio para agregar ., Otra información relevante como restricciones de Usuario.</p>
		                    <br>
							<label class="form-check">
								  <input class="form-check-input" type="checkbox" value="">
								  <span class="form-check-label">
