...
<!-- fin Parte superior Verde -->	
	...
	<div class="container">
		<div class="actions text-left">	
		    <h1>Listado General de Usuarios del Sistema</h1>
	    	<p>Link: menú general / Usuarios / listado general de usuarios</a></p>
	    </div>
		  
		  <form class="form-sign" action="AdUsuario.jsp" method="POST">
		  
		  <div class="row" >
		       <div class="col-12" >
					<div class="actions text-left">		
				         <a href="AdUsuario.jsp"><button type="submit" name="adicionar" class="btn btn-success">Adicionar Registro</button></a>
		      		...
		      		<table id="ejemplo" class="table table-striped table-bordered" style="width:100%">
					        <thead>
								<tr>						
								    <th>Reg.</th>		
									<th>Nombres y Apellidos Usuario </th>
			 						<th>Acciones </th>
								</tr>
							</thead>					
							<tbody>
									...
									try{
										...
										String query="SELECT * FROM usuarios order by idperfil";
											...
											<td>     
										      <div class="btn-group">
										        ...
										        <ul class="dropdown-menu">
											        <li><a href="EditarUsuarios.jsp?idarea=<%=rs.getString(1)%> type="button">Actualizar</a></li>										          
											        <li><a href="#">Ver Detalles</a></li>
											        <li><a href="#">Activar Usuario</a></li>
											        <li><a href="#">Inactivar Usuario</a></li>
										        </ul>
										      </div>
											</td>								
