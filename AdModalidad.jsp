 ...
 <!-- Por ahora estoy haciendo Pruebas de la Informacion de la Tabla para que se pueda Ver., -->
	...
	<div class="container">
		<div class="actions text-left">	
	    	...
	    	<p>Link: menú general / Datos Maestros / modalidad / Adicionar Modalidad</a></p>
	         ...
	         <div class="card-body">
				...
				int idmodalidad = 1;
						try {					
							...
							String sql = "SELECT max(idmodalidad) FROM sac.modalidad";
							ResultSet rst = stmt.executeQuery(sql);
							while (rst.next()) {
								idmodalidad = rst.getInt(1);
								idmodalidad = idmodalidad + 1;
				...
				<form class="form-sign" action="AdmodalidadAction.jsp" method="POST">
					...
					<div class="row">
						<div class="col-md-2 mb-3">
							<label for="codigoidmodalidad" class="form-label" ># Reg.</label>
							<input type="text" name="idmodalidad" class="form-control" value="<%out.println(idmodalidad);%>" readonly="readonly" required>
						</div>
						<div class="col-md-6 mb-3">
							<label for="modalidad" class="form-label">Descripción Modalidad</label> 
							<input type="text" name="modalidad"class="form-control" id="formGroupExampleInput" placeholder="Nombre Modalildad" required>
						</div>						
