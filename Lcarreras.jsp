...
<!-- fin Parte superior Verde -->	
	...
	<div class="container">
		<div class="actions text-left">	
		    <h1>Listado General de Carreras</h1>
	    	<p>Link: menú general / Datos Maestros / carreras</a></p>
	    </div>
		  ...
		  <div class="row">
		       <div class="col-12" >
					<div class="actions text-left">		
				         <a href="#"><button type="submit" name="adicionar" class="btn btn-success">Adicionar Registro</button></a>
