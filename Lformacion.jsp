...
<!-- fin Parte superior Verde -->	
	...
	<div class="container">
		<div class="actions text-left">	
		    <h1>Listado General de Formación</h1>
	    	<p>Link: menú general / Datos Maestros / formación</a></p>
	    </div>
		  
		  <form class="form-sign" action="Adformacion.jsp" method="POST">
		  
		  <div class="row">
		       <div class="col-12" >
					<div class="actions text-left">		
			             <a href="Adformacion.jsp"><button type="submit" name="adicionar" class="btn btn-success">Adicionar Registro</button></a>
		      		...
		      		<table id="ejemplo" class="table table-striped table-bordered" style="width:100%">
					        <thead>
								<tr>						
								    <th>Reg.</th>		
									<th>Nombre del Área Academica o Formación </th>
									<th>Acciones</th>
								</tr>
							</thead>					
							<tbody>
									...
									try{
										...
										String query="SELECT * FROM sac.formacion";
