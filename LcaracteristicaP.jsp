...
<!-- fin Parte superior Verde -->	
	...
	<div class="container">
	      <div class="actions text-left">	
			    <h1>Listado General de Características por Programa</h1>
			   	<p>Link: menú general / Datos Maestros / Características por -Programas</a></p>         		    	
		  </div>
					...
					<div class="actions text-left">		
		      		...
		      		<table id="ejemplo" class="table table-striped table-bordered" style="width:100%">
					        <thead>
								<tr>						
								    <th>Reg.</th>		
									<th>Descripción Característica</th>
									<th>Estado</th>
									<th>Acciones</th>
								</tr>
							</thead>					
							<tbody> 
									...
									try{
										...
										String query="SELECT *, if(estado = 1, 'Activo','Inactivo') as estado FROM factor_caracteristicap";
