...
<!-- fin Parte superior Verde -->	
	...
	<div class="container">
		<div class="actions text-left">	
		    <h1>Listado General de Perfiles de Usuario</h1>
	    	<p>Link: menú general / Datos Maestros / perfiles de usaurio</a></p>
	    </div>
		  
		  <form class="form-sign" action="Adperfiles.jsp" method="POST">
		  
		  <div class="row">
		       <div class="col-12" >
					<div class="actions text-left">		
				         <a href="Adperfiles.jsp"><button type="submit" name="adicionar" class="btn btn-success">Adicionar Registro</button></a>
